"""
Django settings for tst_org_app_1 project.
...
ROOT_URLCONF = 'tst_org_app_1.urls'
...
WSGI_APPLICATION = 'tst_org_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_org_app_1 API",
    "DESCRIPTION": "API documentation for tst_org_app_1 App",
    "VERSION": "v1",
}
